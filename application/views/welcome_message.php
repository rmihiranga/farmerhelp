...
<div class="wrapper">
        ...
        <header class="main-header">
          ...
          <nav class="navbar navbar-static-top">
            ...
            <button class="btn btn-primary" name="go_login">Login</button>
            <button class="btn btn-primary" name="go_register">Register</button>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo base_url();?>"="https://adminlte.io/docs"><i class="fa fa-book"></i> <span>ChatBox</span></a></li>
